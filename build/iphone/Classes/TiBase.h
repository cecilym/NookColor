...
// in simulator we redefine to format for NookColor Developer console
...
{\
	NSString * exceptionName = [@"org.nookcolor." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nookcolor";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UINookColorNativeItemNone = -1, 
	UINookColorNativeItemSpinner = -2,
	UINookColorNativeItemProgressBar = -3,
	
	UINookColorNativeItemSlider = -4,
	UINookColorNativeItemSwitch = -5,
	UINookColorNativeItemMultiButton = -6,
	UINookColorNativeItemSegmented = -7,
	
	UINookColorNativeItemTextView = -8,
	UINookColorNativeItemTextField = -9,
	UINookColorNativeItemSearchBar = -10,
	
	UINookColorNativeItemPicker = -11,
	UINookColorNativeItemDatePicker = -12,
	
	UINookColorNativeItemInfoLight = -13,
	UINookColorNativeItemInfoDark = -14,
	
	UINookColorNativeItemDisclosure = -15,
	
	UINookColorNativeItemContactAdd = -16
};
