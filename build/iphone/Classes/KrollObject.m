...
//@interface NookColorObject : NSObject
//@end

@interface NookColorObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NookColorObject class]])
		{
			for (NSString *key in [[(NookColorObject*)o modules] allKeys])
			{
